  ...
  return (
    ...
    >
      <Link
        ...
        className="block h-48 overflow-hidden rounded-xl bg-gray-100"
      >
      ...
      <div className="mt-4 space-y-2">
        <Link
          to={`/products/${product.id}`}
          className="block truncate text-base font-semibold text-gray-800 transition-colors hover:text-indigo-600"
          title={product.title}
        >
          {product.title}
        </Link>
