        ...
        <article className="rounded-2xl bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-4">
            {cart.map(({ product, quantity }) => (
              <div
                key={product.id}
                className="grid grid-cols-8 gap-4 rounded-xl border border-gray-200 p-4"
              >
                <img
                  src={product.image}
                  alt={product.title}
                  className="col-span-1 h-20 w-20 object-contain"
                />
                ...
                <div className="col-span-2 flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="rounded-md border px-2 py-1 text-gray-600"
                    >
                      -
                    </button>
