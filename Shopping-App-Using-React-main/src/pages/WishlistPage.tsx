    ...
    return (
      <main className="bg-gray-50 min-h-screen p-6">
        <div className="mx-auto max-w-7xl rounded-2xl bg-white p-8 text-center shadow-sm">
          ...
          <p className="mt-2 text-gray-500">Add products to wishlist to save them for later.</p>
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {wishlist.map((product) => (
              <article key={product.id} className="space-y-2 rounded-xl border border-gray-200 p-4">
